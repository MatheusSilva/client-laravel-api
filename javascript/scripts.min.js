...
static listar()
{var jwtoken,codigo,detalhes,alterar,excluir;jwtoken=Util.getCookie('token');var table=jQuery('#tabela01').dataTable({processing:!0,serverSide:!0,dom:"Bfrtip",ajax:{"url":'http://127.0.0.1/laravel-api/public/api/v1/categorias',"dataType":'json',"type":"GET","beforeSend":function(xhr){xhr.setRequestHeader('Authorization','Bearer '+jwtoken)}},columns:[{"class":"details-control","orderable":!1,"searchable":!1,"searchable":!1,"data":null,render:function(data,type,row){codigo=data.codigo_categoria;detalhes="<a href=\"../consultas/detalhe.categoria.htm?codigo="+codigo+"\"><i class='fas fa-info' aria-hidden='true'></i></a>";alterar="<span>  </span><a href=\"../formularios/alterar.categoria.htm?codigo="+codigo+"\"><i class='fas fa-edit'></i></a>";excluir="<span>  </span><a href=\"javascript:Categoria.confirmar("+codigo+")\"><i class='fas fa-trash'></i></a>";return detalhes+alterar+excluir},"defaultContent":"",},{"data":"codigo_categoria",name:"codigo_categoria","width":"60px"},{"data":"nome"},],select:!0,'language':{'url':'../../javascript/Portuguese-Brasil.json'}})}
static detalhe(codigo)
{var xhr=Util.createXHR();xhr.open("GET","http://127.0.0.1/laravel-api/public/api/v1/categorias/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'&&xhr.status=='200'){var data=JSON.parse(xhr.responseText);document.getElementById("codigo").value=data.codigo_categoria;document.getElementById("txtNome").value=data.nome}}
...
{var xhr=Util.createXHR();var ok=window.confirm("Você tem certeza que deseja excluir esta categoria?");if(ok){var mensagem="";if(Util.getCookie('token')==""){mensagem+="Token invalido"}
...
static listar()
{var jwtoken,codigo,detalhes,alterar,excluir;jwtoken=Util.getCookie('token');var table=jQuery('#tabela01').dataTable({processing:!0,serverSide:!0,dom:"Bfrtip",ajax:{"url":'http://127.0.0.1/laravel-api/public/api/v1/divisoes',"dataType":'json',"type":"GET","beforeSend":function(xhr){xhr.setRequestHeader('Authorization','Bearer '+jwtoken)}},columns:[{"class":"details-control","orderable":!1,"searchable":!1,"searchable":!1,"data":null,render:function(data,type,row){codigo=data.codigo_divisao;detalhes="<a href=\"../consultas/detalhe.divisao.htm?codigo="+codigo+"\"><i class='fas fa-info' aria-hidden='true'></i></a>";alterar="<span>  </span><a href=\"../formularios/alterar.divisao.htm?codigo="+codigo+"\"><i class='fas fa-edit'></i></a>";excluir="<span>  </span><a href=\"javascript:Divisao.confirmar("+codigo+")\"><i class='fas fa-trash'></i></a>";return detalhes+alterar+excluir},"defaultContent":"",},{"data":"codigo_divisao",name:"codigo_divisao","width":"60px"},{"data":"nome"},],select:!0,'language':{'url':'../../javascript/Portuguese-Brasil.json'}})}
static detalhe(codigo)
...
static listar()
{var jwtoken,codigo,detalhes,alterar,excluir;jwtoken=Util.getCookie('token');var table=jQuery('#tabela01').dataTable({processing:!0,serverSide:!0,dom:"Bfrtip",ajax:{"url":'http://127.0.0.1/laravel-api/public/api/v1/tecnicos',"dataType":'json',"type":"GET","beforeSend":function(xhr){xhr.setRequestHeader('Authorization','Bearer '+jwtoken)}},columns:[{"class":"details-control","orderable":!1,"searchable":!1,"searchable":!1,"data":null,render:function(data,type,row){codigo=data.codigo_tecnico;detalhes="<a href=\"../consultas/detalhe.tecnico.htm?codigo="+codigo+"\"><i class='fas fa-info' aria-hidden='true'></i></a>";alterar="<span>  </span><a href=\"../formularios/alterar.tecnico.htm?codigo="+codigo+"\"><i class='fas fa-edit'></i></a>";excluir="<span>  </span><a href=\"javascript:Tecnico.confirmar("+codigo+")\"><i class='fas fa-trash'></i></a>";return detalhes+alterar+excluir},"defaultContent":"",},{"data":"codigo_tecnico",name:"codigo_tecnico","width":"60px"},{"data":"nome"},],select:!0,'language':{'url':'../../javascript/Portuguese-Brasil.json'}})}
static detalhe(codigo)
...
static pegarQrCode()
{var xhr=Util.createXHR();if(xhr!=undefined){var token=Util.getCookie('token');if(token!==""){xhr.open("GET","http://127.0.0.1/sistemaRest/api/v1/controller/torcedor.php?a=5&tk="+token,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);document.getElementById("imgbase64").src=json.torcedor.imgbase64;document.getElementById("aviso").innerHTML="Baixe o app Google Authenticator.<br> Escanei o QR CODE com algum app no seu smartphone."}}
xhr.send()}else{alert("Sua sessão expirou.")}}}
...
{document.getElementById("mensagem").innerHTML="<br /><b>Aguarde...</b>";var xhr=Util.createXHR();var mensagem="";if(form.txtSenha.value==""){mensagem+="<br /><b>Você não preencheu a senha</b>"}
...
{document.getElementById("mensagem").innerHTML="<br /><b>Aguarde...</b>";var xhr=Util.createXHR();var mensagem="";if(form.txtEmail.value==""){mensagem+="<br /><b>Você não preencheu o E-mail</b>"}
