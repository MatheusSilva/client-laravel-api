...
{var url="http://localhost/laravel-api/public/api/v1/categorias";if(form!=null&&form.txtNome.value!=undefined&&form.txtNome.value!=''){url+="/search?key-search="+form.txtNome.value}
var xhr=Util.createXHR();if(xhr!=undefined){xhr.open("GET",url,!0);xhr.onload=function(e){var table=document.getElementById("tabela");if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);if(xhr.status=='200'){table.innerHTML="";var len=0;if(json.categorias!=null){len=json.categorias.data.length}
...
{var xhr=Util.createXHR();var ok=window.confirm("Voce tem certeza que deseja excluir?");if(ok){document.getElementById("ajax-loader").style.display='block';var mensagem="";if(Util.getCookie('token')==""){mensagem+="Token invalido"}
...
var jwtoken='';jwtoken=Util.getCookie('token');xhr.setRequestHeader('Authorization','Bearer '+jwtoken);xhr.send()}
static consultar(form)
{var xhr=Util.createXHR();var url="http://localhost/laravel-api/public/api/v1/divisaos";if(form!=null&&form.txtNome.value!=undefined&&form.txtNome.value!=''){url+="/search?key-search="+form.txtNome.value}
...
var temRegistro=!1;var strHTML="<caption class='titulo'>Consulta por nome as divisoes</caption>"+"<thead>"+"<tr>"+"<th width='70px'>A&ccedil;&otilde;es</th>"+"<th width='60px'>C&oacute;digo</th>"+"<th>Nome</th>"+"</tr>"+"</thead>"+"<tbody>";var codigo="",nome="",detalhes="",alterar="",excluir="",acao="";for(var i=0;i<len;i++){codigo=json.divisaos.data[i].codigo_divisao;nome=json.divisaos.data[i].nome;detalhes="<a href=\"../consultas/detalhe.divisao.htm?codigo="+codigo+"\"><span class='glyphicon glyphicon-info-sign' aria-hidden='true'></span></a>";alterar="<span>  </span><a href=\"../formularios/alterar.divisao.htm?codigo="+codigo+"\"><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>";excluir="<span>  </span><a href=\"javascript:Divisao.confirmar("+codigo+")\"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";acao=detalhes+alterar+excluir;strHTML+="<tr>"+"<td>"+acao+"</td>"+"<td>"+codigo+"</td>"+"<td>"+nome+"</td>"+"</tr>";temRegistro=!0}
console.log(json);if(temRegistro==!1){strHTML=json.mensagem}else{strHTML+="</tbody>"+"<tfoot>"+"<tr>"+"<th width='70px'>A&ccedil;&otilde;es</th>"+"<th width='60px'>C&oacute;digo</th>"+"<th>Nome</th>"+"</tr>"+"</tfoot>"}
table.innerHTML=strHTML;table.style.display=""}else if(xhr.status=='422'){var strErrosValidate="";if(json.validate_error!==undefined&&json.json.validate_error.key-search!==undefined){strErrosValidate+=json.validate_error.key-search[0]}
if(strErrosValidate!==''){table.innerHTML="<br /><b>"+strErrosValidate+"</b>"}else{table.innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else if(xhr.status=='500'){if(json.error!==undefined&&json.error==='token_invalid'){table.innerHTML="<br /><b>Token inválido. Faça o login novamente.</b>"}else{table.innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else if(xhr.status=='401'){if(json.error!==undefined&&json.error==='token_expired'){table.innerHTML="<br /><b>Token expirado. Faça o login novamente.</b>"}else{table.innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else{table.innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}}
var jwtoken='';jwtoken=Util.getCookie('token');xhr.setRequestHeader('Authorization','Bearer '+jwtoken);xhr.send()}}
static callbackCadAltDel(xhr,op)
...
if(strErrosValidate!==''){document.getElementById("mensagem").innerHTML="<br /><b>"+strErrosValidate+"</b>"}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else if(xhr.status=='500'){if(json.error!==undefined&&json.error==='token_invalid'){document.getElementById("mensagem").innerHTML="<br /><b>Token inválido. Faça o login novamente.</b>"}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else if(xhr.status=='401'){if(json.error!==undefined&&json.error==='token_expired'){document.getElementById("mensagem").innerHTML="<br /><b>Token expirado. Faça o login novamente.</b>"}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}}
static confirmar(codigo)
{var xhr=Util.createXHR();var ok=window.confirm("Voce tem certeza que deseja excluir?");if(ok&&xhr!=undefined){var mensagem="";if(codigo==""){mensagem+="Código invalido"}
...
var consulta="";var xhr=Util.createXHR();if(mensagem==""&&xhr!=undefined){xhr.open("PUT","http://localhost/laravel-api/public/api/v1/divisaos/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Divisao.callbackCadAltDel(xhr,'alt')}
...
var jwtoken='';jwtoken=Util.getCookie('token');xhr.setRequestHeader('Authorization','Bearer '+jwtoken);xhr.send()}
static consultar(form)
{var xhr=Util.createXHR();var url="http://localhost/laravel-api/public/api/v1/tecnicos";if(form!=null&&form.txtNome.value!=undefined&&form.txtNome.value!=''){url+="/search?key-search="+form.txtNome.value}
...
if(strErrosValidate!==''){document.getElementById("mensagem").innerHTML="<br /><b>"+strErrosValidate+"</b>"}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else if(xhr.status=='500'){if(json.error!==undefined&&json.error==='token_invalid'){document.getElementById("mensagem").innerHTML="<br /><b>Token inválido. Faça o login novamente.</b>"}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else if(xhr.status=='401'){if(json.error!==undefined&&json.error==='token_expired'){document.getElementById("mensagem").innerHTML="<br /><b>Token expirado. Faça o login novamente.</b>"}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}else{document.getElementById("mensagem").innerHTML="<br /><b>Algum erro desconhecido ocorreu.</b>"}}}
static confirmar(codigo)
{var xhr=Util.createXHR();var ok=window.confirm("Você tem certeza que deseja excluir?");if(ok&&xhr!=undefined){var mensagem="";if(codigo==""){mensagem+="Código invalido"}
...
var xhr=Util.createXHR();if(mensagem===""&&xhr!=undefined){xhr.open("GET","http://localhost/sistemaRest/api/v1/controller/time.php?a=5"+codigo+consulta,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);alert(json.mensagem);location.reload()}}
xhr.send()}else{alert(mensagem)}}}
static listaTodosTimes()
{var xhr=Util.createXHR();var token=Util.getCookie('token');if(xhr!=undefined){xhr.open("GET","http://localhost/sistemaRest/api/v1/controller/time.php?tk="+token,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);var len=0;if(json.times!=undefined){var len=json.times.length}
...
{var xhr=Util.createXHR();if(xhr!=undefined){if(codigo==undefined){codigo=""}
...
xhr.setRequestHeader('tk',Util.getCookie('token'));xhr.send()}}
