...
static logado()
{var mensagem="";var xhr=Util.createXHR();if(xhr!=undefined){xhr.open("GET","http://192.168.33.10/laravel-api/public/api/v1/logado",!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'&&xhr.status!='200'){window.location="http://192.168.33.10/client-laravel-api/adm/formularios/form.login.htm"}}
var jwtoken='';jwtoken=Util.getCookie('token');if(jwtoken!=''){xhr.setRequestHeader('Authorization','Bearer '+jwtoken);xhr.send()}else{window.location="http://192.168.33.10/client-laravel-api/adm/formularios/form.login.htm"}}else{window.location="http://192.168.33.10/client-laravel-api/adm/formularios/form.login.htm"}}
static logout()
{var mensagem="";var xhr=Util.createXHR();if(xhr!=undefined){xhr.open("GET","http://192.168.33.10/laravel-api/public/api/v1/logout",!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'){Util.createCookie('token','',-1);window.location="http://192.168.33.10/client-laravel-api/site/paginas/home.htm"}}
var jwtoken='';jwtoken=Util.getCookie('token');if(jwtoken!=''){xhr.setRequestHeader('Authorization','Bearer '+jwtoken);xhr.send()}
window.location="http://192.168.33.10/client-laravel-api/site/paginas/home.htm"}else{Util.createCookie('token','',-1);window.location="http://192.168.33.10/client-laravel-api/site/paginas/home.htm"}}};class Login
{static valida(form)
...
document.getElementById("mensagem").innerHTML="<br /><b>Aguarde...</b>";var mensagem="";var xhr=Util.createXHR();if(mensagem==""&&xhr!=undefined&&'withCredentials' in xhr){xhr.open("POST","http://192.168.33.10/laravel-api/public/api/v1/auth",!0);xhr.setRequestHeader("Access-Control-Allow-Origin","*");xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);if(xhr.status=='200'){Util.createCookie('token',json.token,'1');window.location="http://192.168.33.10/client-laravel-api/adm/paginas/home.htm"}else if(xhr.status=='422'){var strErrosValidate="";if(json.json.validate_error.email!==undefined){strErrosValidate+=json.validate_error.email[0]}
...
if(mensagem==""&&xhr!=undefined){xhr.open("DELETE","http://192.168.33.10/laravel-api/public/api/v1/categorias/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Tecnico.callbackCadAltDel(xhr,'exc');location.reload()}
...
if(mensagem==""&&xhr!=undefined){xhr.open("POST","http://192.168.33.10/laravel-api/public/api/v1/categorias",!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Categoria.callbackCadAltDel(xhr,'cad')}
...
var consulta="";var xhr=Util.createXHR();if(mensagem==""&&xhr!=undefined){xhr.open("PUT","http://192.168.33.10/laravel-api/public/api/v1/categorias/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Categoria.callbackCadAltDel(xhr,'alt')}
...
if(mensagem==""){xhr.open("DELETE","http://192.168.33.10/laravel-api/public/api/v1/divisoes/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Tecnico.callbackCadAltDel(xhr,'exc');location.reload()}
var jwtoken='';jwtoken=Util.getCookie('token');xhr.setRequestHeader('Authorization','Bearer '+jwtoken);xhr.send()}else{alert(mensagem)}}}
static cadastrar(form)
...
if(mensagem==""&&xhr!=undefined){xhr.open("POST","http://192.168.33.10/laravel-api/public/api/v1/divisoes",!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Divisao.callbackCadAltDel(xhr,'cad')}
...
var consulta="";var xhr=Util.createXHR();if(mensagem==""&&xhr!=undefined){xhr.open("PUT","http://192.168.33.10/laravel-api/public/api/v1/divisoes/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Divisao.callbackCadAltDel(xhr,'alt')}
...
if(mensagem==""){xhr.open("DELETE","http://192.168.33.10/laravel-api/public/api/v1/tecnicos/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Tecnico.callbackCadAltDel(xhr,'exc');location.reload()}
var jwtoken='';jwtoken=Util.getCookie('token');xhr.setRequestHeader('Authorization','Bearer '+jwtoken);xhr.send()}else{alert(mensagem)}}}
static cadastrar(form)
...
var xhr=Util.createXHR();if(mensagem==""&&xhr!=undefined){xhr.open("POST","http://192.168.33.10/laravel-api/public/api/v1/tecnicos",!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Tecnico.callbackCadAltDel(xhr,'cad');location.reload()}
...
var xhr=Util.createXHR();if(mensagem==""&&xhr!=undefined){xhr.open("PUT","http://192.168.33.10/laravel-api/public/api/v1/tecnicos/"+codigo,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Tecnico.callbackCadAltDel(xhr,'alt')}
...
if(mensagem==""&&xhr!=undefined){xhr.open("POST","http://192.168.33.10/laravel-api/public/api/v1/cadusuario",!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){Torcedor.callbackCadAlt(xhr,'cad')}
...
if(mensagem==""&&xhr!=undefined){xhr.open("POST","http://192.168.33.10/sistemaRest/api/v1/controller/torcedor.php?a=8"+consulta,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'&&xhr.status=='200'){var json=JSON.parse(xhr.responseText);document.getElementById("mensagem").innerHTML="<br /><b>"+json.mensagem+"</b>"}}
xhr.send(Torcedor.formToJSON(form))}else{document.getElementById("mensagem").innerHTML=mensagem}}
