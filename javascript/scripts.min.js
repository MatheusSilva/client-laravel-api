...
static listar()
{var jwtoken,codigo,detalhes,alterar,excluir;jwtoken=Util.getCookie('token');var table=jQuery('#tabela01').dataTable({processing:!0,serverSide:!0,dom:"Bfrtip",ajax:{"url":'http://localhost/laravel-api/public/api/v1/divisoes',"dataType":'json',"type":"GET","beforeSend":function(xhr){xhr.setRequestHeader('Authorization','Bearer '+jwtoken)}},columns:[{"class":"details-control","orderable":!1,"searchable":!1,"searchable":!1,"data":null,render:function(data,type,row){codigo=data.codigo_categoria;detalhes="<a href=\"../consultas/detalhe.divisao.htm?codigo="+codigo+"\"><span class='glyphicon glyphicon-info-sign' aria-hidden='true'></span></a>";alterar="<span>  </span><a href=\"../formularios/alterar.divisao.htm?codigo="+codigo+"\"><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>";excluir="<span>  </span><a href=\"javascript:Divisao.confirmar("+codigo+")\"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";return detalhes+alterar+excluir},"defaultContent":"",},{"data":"codigo_divisao",name:"codigo_divisao","width":"60px"},{"data":"nome"},],select:!0,'language':{'url':'../../javascript/Portuguese-Brasil.json'}})}
static detalhe(codigo)
...
static listar()
{var jwtoken,codigo,detalhes,alterar,excluir;jwtoken=Util.getCookie('token');var table=jQuery('#tabela01').dataTable({processing:!0,serverSide:!0,dom:"Bfrtip",ajax:{"url":'http://localhost/laravel-api/public/api/v1/tecnicos',"dataType":'json',"type":"GET","beforeSend":function(xhr){xhr.setRequestHeader('Authorization','Bearer '+jwtoken)}},columns:[{"class":"details-control","orderable":!1,"searchable":!1,"searchable":!1,"data":null,render:function(data,type,row){codigo=data.codigo_categoria;detalhes="<a href=\"../consultas/detalhe.tecnico.htm?codigo="+codigo+"\"><span class='glyphicon glyphicon-info-sign' aria-hidden='true'></span></a>";alterar="<span>  </span><a href=\"../formularios/alterar.tecnico.htm?codigo="+codigo+"\"><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>";excluir="<span>  </span><a href=\"javascript:Tecnico.confirmar("+codigo+")\"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";return detalhes+alterar+excluir},"defaultContent":"",},{"data":"codigo_tecnico",name:"codigo_tecnico","width":"60px"},{"data":"nome"},],select:!0,'language':{'url':'../../javascript/Portuguese-Brasil.json'}})}
static detalhe(codigo)
